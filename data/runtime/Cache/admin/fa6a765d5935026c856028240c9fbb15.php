...
</style><form id="info_form" action="<?php echo U(MODULE_NAME.'/add');?>" method="post" enctype="multipart/form-data"><div class="pad_10"><div class="col_tab"><ul class="J_tabs tab_but cu_li"><li class="current"><?php echo L('article_basic');?></li></ul><div class="J_panes"><div class="content_list pad_10"><table><tr><td style="width: 80%;"><table width="100%" cellspacing="0" class="table_form"><tr><th width="100">中文名称：</th><td><input type="text" name="name_cn" class="input-text" value="<?php echo ($info["name_cn"]); ?>"/></td></tr><tr><th>法文名称：</th><td><input type="text" name="name_fr" class="input-text" value="<?php echo ($info["name_fr"]); ?>"/></td></tr><tr><th>封面图片:</th><td><?php if($info['cover_image_name']): ?><div class="img_border"><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo attach($info['cover_image_name'],'zhaoshang');?>"><img src="<?php echo attach($info['cover_image_name'],'zhaoshang');?>" width="60" height="60" /></span></div><input type="hidden" name="cover_image_name" value="<?php echo ($info["cover_image_name"]); ?>" /><?php else: ?>
                                        上传：<input type="file" name="cover_image_name" class="input-text"  style="width:200px;" />
                                        &nbsp;&nbsp;<input type="text" class="input-text J_tip" data-default="或者输入外部图片地址" name="cover_image_name" value="<?php echo ($info["cover_image_name"]); ?>" size="55"/><?php endif; ?></td></tr><tr><th>Logo图片：</th><td><?php if($info['logo_image_name']): ?><div class="img_border"><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo attach($info['logo_image_name'],'zhaoshang');?>"><img src="<?php echo attach($info['logo_image_name'],'zhaoshang');?>" width="60" height="60" /></span></div><input type="hidden" name="logo_image_name" value="<?php echo ($info["logo_image_name"]); ?>" /><?php else: ?>
                                        上传：<input type="file" name="logo_image_name" class="input-text"  style="width:200px;" />
                                        &nbsp;&nbsp;<input type="text" class="input-text J_tip" data-default="或者输入外部图片地址" name="logo_image_name" value="<?php echo ($info["logo_image_name"]); ?>" size="55"/><?php endif; ?></td></tr><tr><th>版本：</th><td><input type="text" name="num_version" id="num_version" class="input-text"  value="<?php echo ($info["num_version"]); ?>"/></td></tr><tr><th>状态：</th><td><label><input type="radio" name="status" class="radio_style" value="1" <?php if($info['status'] == 1): ?>checked="checked"<?php endif; ?>/> 已通过</label>&nbsp;&nbsp;
