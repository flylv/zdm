...
class indexAction extends backendAction {
    ...
    public function panel() {
        $message = array();
        if (is_dir('./install')) {
            $message[] = array('type' => 'error', 'content' => "&#24744;&#36824;&#27809;&#26377;&#21024;&#38500; install &#25991;&#20214;&#22841;&#65292;&#20986;&#20110;&#23433;&#20840;&#30340;&#32771;&#34385;&#65292;&#25105;&#20204;&#24314;&#35758;&#24744;&#21024;&#38500; install &#25991;&#20214;&#22841;&#12290;",);
        }
        if (APP_DEBUG == true) {
            $message[] = array('type' => 'error', 'content' => "&#24744;&#32593;&#31449;&#30340; DEBUG &#27809;&#26377;&#20851;&#38381;&#65292;&#20986;&#20110;&#23433;&#20840;&#32771;&#34385;&#65292;&#25105;&#20204;&#24314;&#35758;&#24744;&#20851;&#38381;&#31243;&#24207; DEBUG&#12290;",);
        }
        if (!function_exists("curl_getinfo")) {
            $message[] = array('type' => 'error', 'content' => "&#31995;&#32479;&#19981;&#25903;&#25345; CURL ,&#23558;&#26080;&#27861;&#37319;&#38598;&#21830;&#21697;&#25968;&#25454;&#12290;",);
        }
        $this->assign('message', $message);
        $system_info = array('ZhiPHP_version' => ZHI_VERSION . ' RELEASE ' . ZHI_RELEASE . ' [<a href="http://www.adminn.cn/" class="blue" target="_blank">&#26597;&#30475;&#26368;&#26032;&#29256;&#26412;</a>]', 'server_domain' => $_SERVER['SERVER_NAME'] . ' [ ' . gethostbyname($_SERVER['SERVER_NAME']) . ' ]', 'server_os' => PHP_OS, 'web_server' => $_SERVER["SERVER_SOFTWARE"], 'php_version' => PHP_VERSION, 'mysql_version' => mysql_get_server_info(), 'upload_max_filesize' => ini_get('upload_max_filesize'), 'max_execution_time' => ini_get('max_execution_time') . '&#31186;', 'safe_mode' => (boolean)ini_get('safe_mode') ? L('yes') : L('no'), 'zlib' => function_exists('gzclose') ? L('yes') : L('no'), 'curl' => function_exists("curl_getinfo") ? L('yes') : L('no'), 'timezone' => function_exists("date_default_timezone_get") ? date_default_timezone_get() : L('no'));
    ...
    public function login() {
        if (IS_POST) {
            ...
            $data = array('id' => $admin['id'], 'role_id' => $admin['role_id'], 'role_name' => D('admin_role')->where("id=$admin[role_id]")->getField("name"), 'username' => $admin['username'], 'token' => md5($username . md5($password)),);
